...
## Technical Details
The FPGA board chosen for this project is DE-10 Lite. 
Unity is used as the platform to create the game. 
An AWS instance is set up to perform the role of a server.
